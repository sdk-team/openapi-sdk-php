 ...
 * @method ConfigurationSynchronizationJob configurationSynchronizationJob($options = [])
 ...
 * @method self withInitializationStructureLoad(bool $initializationStructureLoad)
 * @method bool getInitializationDataLoad
 * @method self withInitializationDataLoad(bool $initializationDataLoad)
 * @method string getSynchronizationObject
 * @method self withSynchronizationObject(string $synchronizationObject)
 * @method string getOwnerId
 * @method self withOwnerId(string $ownerId)
 */
class ConfigurationSynchronizationJob extends Roa
{
    use R;
}
