 ...
 * @method Boolean getInitialization.StructureLoad
 * @method self withInitialization.StructureLoad
 * @method Boolean getInitialization.DataLoad
 * @method self withInitialization.DataLoad
 * @method string getSynchronizationObject
 * @method self withSynchronizationObject
 * @method string getOwnerId
 * @method self withOwnerId
 */
final class ConfigurationSynchronizationJob extends RpcRequest
{
}
